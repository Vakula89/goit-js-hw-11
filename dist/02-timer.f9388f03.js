...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (!validateSelectedDate(selectedDateTime)) return;
...
function addLeadingZero(value) {
    return (0, _lodash.padStart)(value, 2, "0");
}
...
function startTimer() {
    ...
    if (!valueElems || !valueElems.length || valueElems.length < 4) return;
    if (diffMs <= 0) {
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","notiflix/dist/notiflix-3.2.5.min.css":"jvRD8","flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"jvRD8":[function() {},{}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
