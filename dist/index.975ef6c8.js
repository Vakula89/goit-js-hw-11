...
var _pixabayApi = require("./js/pixabayApi");
var _pixabayApiDefault = parcelHelpers.interopDefault(_pixabayApi);
...
function onSubmit(ev) {
    ev.preventDefault();
    if (inputRef.getAttribute("disabled")) return;
...
function onScroll() {
    ...
    if (scrolled > clientHeight) toBtnTop.classList.add("btn-to-top--visible");
    if (scrolled < clientHeight) toBtnTop.classList.remove("btn-to-top--visible");
    let isDisabled = inputRef.getAttribute("disabled");
    if (isDisabled) return;
    if (clientHeight + scrollTop >= scrollHeight - 5 && page > 0) showLoading();
}
...
function onLoadMoreBtn() {
    ...
    if (page > totalPages) {
        ...
        loading.classList.remove("show");
        (0, _notiflixNotifyAio.Notify).warning("We are sorry, but you have reached the end of search results.");
        page = 0;
        return;
    }
    load();
...
function load() {
    (0, _pixabayApiDefault.default)(q, page, perPage).then((responseData)=>{
        if (page === 1) galleryRef.innerHTML = "";
        ...
        if (page === 1) (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${responseData.data.total} images.`);
        renderGallery(responseData.data.hits);
        loadMoreBtn.classList.toggle("is-hidden", !(responseData.data.total > perPage));
        if (!simpleLightBox) simpleLightBox = new (0, _simplelightboxDefault.default)(".gallery a");
        else simpleLightBox.refresh();
    }).catch((error)=>{
        (0, _notiflixNotifyAio.Notify).failure("Something bad happened. Check the browser console");
        console.warn(error);
    }).finally(()=>{
        setTimeout(()=>{
            inputRef.removeAttribute("disabled");
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix/build/notiflix-notify-aio":"eXQLZ","notiflix/dist/notiflix-3.2.5.min.css":"jvRD8","./js/pixabayApi":"9SmCF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"jvRD8":[function() {},{}],"9SmCF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const API_KEY = "29557791-cd23ce7ea93e5957581ac5af8";
async function fetchSearch(_query = "random", _page = 1, _perPage = 40) {
    const query = encodeURI(_query);
    const page = encodeURI(_page);
    const perPage = encodeURI(_perPage);
    return await (0, _axiosDefault.default)(`https://pixabay.com/api/?key=${API_KEY}&q=${query}&page=${page}&per_page=${perPage}&image_type=photo&orientation=horizontal&safesearch=true`);
}
